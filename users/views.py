...
def dashboard(request):
    ...
    return render(request, 'dashboard.html', {'events': events, 'total_registrations': total_registrations})
...
def existing_events(request):
    events = Event.objects.all()
    return render(request, 'existing_events.html', {'events': events})

def view_event_registrations(request):
    events = Event.objects.all()
    return render(request, 'view_registrations.html', {'events': events})
